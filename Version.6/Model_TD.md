...
Insert customers table in to the project by selecting the checkbox for customers then click on update button to save the changes made.
...
**Image 14**
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUzMzc2NzQ0OCwtMTQ2ODQzNjQ2NSwxNT
