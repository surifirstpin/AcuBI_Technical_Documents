...
# Maps
Maps enables users to visualize the geographic data on reactive and interactive maps. To carry out maps  in AcuBi,Your query should include at least one dimension based on geographic data.  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MjE4MzQwMjYsNTc4NDgyNDcsMjA2OT
A0NzczNV19
-->