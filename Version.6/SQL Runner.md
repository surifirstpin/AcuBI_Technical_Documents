...
- IWrite SQL query from scratch and run the same, make sure the dialects used in SQL runner should match the database dialects.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM3Njk3MjYxMiwxODYwNDg0NzZdfQ==
-->